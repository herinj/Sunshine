 ...
 */
package com.example.jariwher.sunshine.app.data;
...
public class TestDb extends AndroidTestCase {
    ...
    public void testCreateDb() throws Throwable {
        ...
        final HashSet<String> pklocationhasset = new HashSet<String>();
        pklocationhasset.add(WeatherContract.LocationEntry._ID);
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        Long returncd = db.insert(WeatherContract.WeatherEntry.TABLE_NAME, null, weathervalues);

        assertTrue(returncd != -1);
    ...
    public long insertLocation() {
        ...
        // Insert ContentValues into database and get a row ID back
        Long returncd = db.insert(WeatherContract.LocationEntry.TABLE_NAME, null, testValues);
