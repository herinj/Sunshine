...
import com.example.jariwher.sunshine.app.BuildConfig;
import com.example.jariwher.sunshine.app.MainActivity;
import com.example.jariwher.sunshine.app.R;
import com.example.jariwher.sunshine.app.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        Log.d(LOG_TAG, "on PerformSync :" + syncResult.toString());
        ...
        String units = "metric";
        int numDays = 14;
        String apiKey = "a957c4457a12ca0ef2b893f5dd6f2523";
        ...
        try {
            ...
            Log.d("syncadtp ", "url :" + builtUri.toString());
