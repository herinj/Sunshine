...
public class Utility {
    ...
    static public void resetLocationStatus(Context c){
        ...
        spe.putInt(c.getString(R.string.pref_location_status_key),SunshineSyncAdapter.LOCATION_STATUS_INVALID);
        spe.apply();
    }
  /*  public static boolean toNotify(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        return prefs.getString(context.getString(R.string.pref_notify_key),
                context.getString(R.string.pref_notify_default))
                .equals(context.getString(R.string.pref_notify_default));
    }*/
    ...
    public static String getArtUrlForWeatherCondition(Context context, int weatherId) {
        ...
        Log.d("Utitlity ","format url:" + formatArtUrl );
        if (weatherId >= 200 && weatherId <= 232) {
